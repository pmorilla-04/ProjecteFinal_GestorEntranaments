...
public class frmEntranaments extends javax.swing.JFrame {
    ...
    public frmEntranaments() {
        ...
        afegirListenerSeleccioTaula(tblEntrenaments);
   ...
   private void afegirListenerSeleccioTaula(JTable taula) {
    ...
    tblEntrenaments.getSelectionModel().addListSelectionListener(e -> {
        ...
        if (!e.getValueIsAdjusting()) {
            ...
            if (fila != -1) {
                ...
                // OMPLIR CAMPS
                txtId.setText(taula.getValueAt(fila, 0).toString());
                txtData.setText(taula.getValueAt(fila, 1).toString());
                txtDurada.setText(taula.getValueAt(fila, 2).toString());
                txtDistancia.setText(taula.getValueAt(fila, 3).toString());
                txtDescripcio.setText(taula.getValueAt(fila, 4).toString());

                cbmIntensitat.setSelectedItem(
                        taula.getValueAt(fila, 5).toString()
                );

                chkCompletat.setSelected(
                        Boolean.parseBoolean(
                                taula.getValueAt(fila, 6).toString()
                        )
                );

                txtUsuari.setText(taula.getValueAt(fila, 7).toString());

                cbmTipus.setSelectedItem(
                        taula.getValueAt(fila, 8).toString()
                );
